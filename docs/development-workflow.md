...
- 2026-07-27：产品详情补充动态 Tips、已加入状态与重复添加兜底；孕哺“不方便透露”在适配规则中按未孕处理。
- 2026-07-23：README 版本说明补充 V1、V2 完成状态标记。
- 2026-07-21：当前用户相关接口统一切换为登录态解析，前端 Profile、Product、Settings 不再把 `user_id` 拼入 URL 或 query。
- 2026-07-21：新增 DeepSeek Chat V2 实施计划；前端 Sass 预处理切换 modern API，并将本地开发代理统一为 `127.0.0.1`。
